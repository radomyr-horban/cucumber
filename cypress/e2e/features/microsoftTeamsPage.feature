Feature: Microsoft Teams page
  ...
  Scenario: Submitting the form with valid data 
    ...
    When I fill in the form with valid data on the "microsoftTeamsPage"
  ...
  Scenario: Submitting the form with invalid data 
    ...
    Then An error message is displayed under the "firstNameInput" input field on the "microsoftTeamsPage"

    When I set the "firstNameInput" input field with "Tom"
    When I click on the “APPLY NOW” button
    Then An error message is displayed under the "lastNameInput" input field on the "microsoftTeamsPage"
